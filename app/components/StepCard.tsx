...
export const StepCard: React.FC<StepCardProps> = ({
  ...
  return (
    <article className={`flex relative flex-col items-center px-10 pt-5 pb-8 lg:max-w-full text-3xl font-bold text-center text-white rounded-3xl bg-[linear-gradient(180deg,#A436F1_32.5%,#A267FE_100%)] min-h-[679px] md:w-full lg:w-[681px]  ${className}`}>
      ...
      />
      <span className="absolute z-0 self-start h-3 leading-none text-purple-600 left-[41px] top-[35px] w-[8px]">
      ...
      {headerImage && (
        <div className="flex">
          ...
          loading="lazy"
          src={headerImage}
          className="object-contain z-0 max-w-full  aspect-[1.91] h-[60px] w-[62]"
          alt="Header illustration"
        />
        {stepNumber === "1" ? <img className='-ml-4 z-[999] h-[55px] w-[50px]' src='/assets/g2.png' /> : null}
        </div>
      )}
