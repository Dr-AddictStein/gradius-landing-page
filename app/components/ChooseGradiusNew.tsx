    ...
    <div className="relative md:my-12 lg:mt-[120px] md:mt-20 -mt-16 flex flex-col items-center">
      <div className="text-center relative">
        <motion.h3
          ...
          className="text-3xl lg:text-[64px] font-[Inter] font-medium leading-[100px] tracking-tight bg-gradient-to-b from-[#A436F1] to-[#6E27D5] text-transparent bg-clip-text drop-shadow-[0px_0px_15px_#A436F1]"
        >
          Backed by
        </motion.h3>
        ...
        <motion.h1
          ...
          viewport={{ once: false, amount: 0.2 }}
          transition={{ duration: 0.6, ease: "easeOut" }}
          className="text-3xl lg:text-[100px] md:mt-0 -mt-10 leading-tight bg-gradient-to-b from-[#6E27D5] to-[#39146F] text-transparent bg-clip-text drop-shadow-[0px_0px_15px_#A436F1]"
        >
          Cognitive Research
        </motion.h1>
      </div>
