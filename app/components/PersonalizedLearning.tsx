        ...
        >
          ...
          <div className="flex-1 relative text-[#F3ECFEB2]">
            <h2 className="md:text-4xl text-xl mt-7 font-semibold leading-snug">
              ...
              identifies your <br /><span className="text-[#A436F1]"> learning needs...</span>
      ...
      <div className="my-20  w-full">
        ...
        <motion.div initial={{ scale: 0.8, opacity: 0, filter: "blur(10px)" }}
          ...
          <div className="flex-1  relative text-[#F3ECFEB2]">
            ...
            <h2 className="text-xl text-[#FFFFFF]  md:text-4xl  font-semibold leading-snug">

              ...and makes you overcome
              <br /> them <span className="text-[#A436F1] ">your way</span> !
            ...
            <div className="my-2">
              ...
              <p className="text-[#FFFFFF]">Tailored Explanations: Gradius' tutor explains difficult concepts in a way that aligns with your unique learning style </p>
              <div className="border my-4 border-[#F3ECFE1A]"></div>
            </div>
            <div className="my-2">
              <Image height={24} width={24} alt="Star" src={'/StarMid.png'} className="drop-shadow-glow absolute -left-8 top-70%" />
              <p className="text-[#FFFFFF]">Personalized Recommendations: Gradius gives periodic tailored recommendations, such as videos or other resources, that mat ch the way you learn best</p>
              <div className="border my-4 border-[#F3ECFE1A]"></div>
            </div>
