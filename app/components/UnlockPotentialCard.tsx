...
export const UnlockPotentialCard: React.FC = () => {
  return (
    <>
      <article className="flex relative flex-col items-center px-10 pt-9 lg:pb-40 lg:mt-20 mt-14 max-w-full lg:w-[800px] mx-auto h-[350px]  text-3xl font-bold leading-none text-center text-white rounded-3xl bg-[linear-gradient(180deg,#A436F1_32.5%,#A267FE_100%)] max-md:px-5 max-md:pb-24 max-md:mt-10">
        <img
          loading="lazy"
